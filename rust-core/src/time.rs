...
pub fn julian_date(year: i32, month: u32, day: u32) -> f64 {
    ...
    let b = if year < 1582 || (year == 1582 && month < 10) || (year == 1582 && month == 10 && day <= 4) {
        0.0
    } else {
...
pub fn get_sidereal_time(_longitude: f64, date_time: DateTime) -> f64 {
    ...
    let total_hours = date_time.hour as f64 + date_time.minute as f64 / 60.0 + date_time.second as f64 / 3600.0;
